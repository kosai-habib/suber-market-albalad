        ...
        <div className="min-h-[calc(100vh-80px)] flex items-center justify-center p-6 bg-transparent overflow-hidden">
            ...
            >
                <div className="flex flex-col gap-3 mb-12 text-center">
                    ...
                    <h1 className="text-4xl font-heading font-black text-white tracking-tight">Login</h1>
                    <p className="text-white/40 font-medium">Access your premium grocery experience</p>
                </div>
