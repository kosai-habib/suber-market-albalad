        ...
        <div className="min-h-[calc(100vh-80px)] flex items-center justify-center p-4 md:p-6 bg-transparent overflow-hidden">
            ...
            >
                <div className="flex flex-col gap-3 mb-8 md:mb-12 text-center w-full">
                    <h1 className="text-3xl md:text-4xl font-heading font-black text-text dark:text-white tracking-tight">Login</h1>
                    <p className="text-text-muted dark:text-white/40 font-medium text-sm md:text-base">Access your premium grocery experience</p>
                </div>
                ...
                <div className="mt-8 md:mt-12 flex flex-col gap-4 md:gap-6 text-center w-full">
                    <p className="text-sm text-text-muted dark:text-white/40 font-medium tracking-tight">
                        New to Albalad? {' '}
                        <Link href="/auth/register" className="text-primary font-black hover:text-text dark:hover:text-white transition-colors">
                            Join the club
                        </Link>
                    </p>
